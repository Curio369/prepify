...
const steps = [
  ...
  },
  {
    number: "02",
    title: "Practice",
    subtitle: "like it's real",
    description: "Full NTA interface with timer, question palette and mark for review. Exactly like JEE/NEET.",
  ...
  },
  {
    ...
    title: "Analyze",
    subtitle: "& improve",
    description: "Get AI solutions for every question. Track weak chapters. Get better every day.",
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/30">Practice.</span>
              <span className="block text-white/10">Conquer.</span>
            </h2>
          </div>
