...
// 1. Rename the main function to an internal component
...
// 2. Wrap it securely in Suspense for the Vercel builder
export default function Exam() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-emerald-500 text-sm font-bold font-mono animate-pulse">Initializing NTA Environment...</div>
      </div>
    }>
      <ExamContent />
    </Suspense>
