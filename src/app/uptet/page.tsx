    ...
    <div className={`min-h-screen w-full ${bg} ${txt} flex flex-col overflow-x-hidden transition-colors duration-300`} style={{ fontFamily: 'var(--font-space), var(--font-geist-sans), sans-serif' }}>
      ...
      <div className="flex-1 flex flex-col md:flex-row items-start md:items-center justify-center gap-10 px-4 md:px-10 py-10 max-w-5xl mx-auto w-full">
        ...
        <div className="w-full md:w-[420px] shrink-0">
          ...
          <article className="mt-12 max-w-3xl mx-auto text-left text-zinc-300 leading-relaxed space-y-8">
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">UPTET 2026: A Complete Guide</h2>
              <p>
                The Uttar Pradesh Teacher Eligibility Test (UPTET) is a state-level examination conducted by the
                Uttar Pradesh Basic Education Board (UPBEB) to certify candidates for teaching posts in government
                and aided schools across Uttar Pradesh. Clearing UPTET is a mandatory eligibility requirement for
                anyone aspiring to become a primary (Classes 1–5) or upper-primary (Classes 6–8) teacher in the state.
              </p>
              <p className="mt-3">
                Prepify gives you free, unlimited UPTET mock tests in a real exam-like interface — in both Hindi and
                English — so you can practise exactly the way you&apos;ll write the actual paper. Below is everything you
                need to know to plan your preparation.
              </p>
            </section>

            <section>
              <h3 className="text-xl font-semibold text-white mb-3">UPTET Exam Pattern</h3>
              <p>
                UPTET has two papers. <strong className="text-white">Paper I</strong> is for candidates who want to
                teach Classes 1–5, and <strong className="text-white">Paper II</strong> is for those targeting Classes
                6–8. Each paper carries 150 marks, contains 150 multiple-choice questions, and must be completed in
                2 hours 30 minutes. There is <strong className="text-white">no negative marking</strong>, so you should
                attempt every question.
              </p>
              <ul className="list-disc pl-5 mt-3 space-y-1.5">
                <li><strong className="text-white">Paper I (Class 1–5):</strong> Child Development &amp; Pedagogy, Language I (Hindi), Language II (English/Urdu/Sanskrit), Mathematics, and Environmental Studies — 30 marks each.</li>
                <li><strong className="text-white">Paper II (Class 6–8):</strong> Child Development &amp; Pedagogy, Language I, Language II, and then either Mathematics &amp; Science (for the science stream) or Social Studies — 60 marks.</li>
              </ul>
              <p className="mt-3">
                See the full subject-wise breakdown on our <a href="/uptet/syllabus" className="text-blue-400 underline">UPTET Syllabus 2026</a> page.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                To appear for UPTET Paper I, you generally need a senior secondary (10+2) qualification with at least
                50% marks along with a diploma/degree in elementary education (such as D.El.Ed or BTC). For Paper II,
                a bachelor&apos;s degree along with the relevant teaching qualification (B.Ed or D.El.Ed) is required.
                Always confirm the exact criteria from the official UPBEB notification for the current cycle.
              </p>
            </section>

            <section>
              <h3 className="text-xl font-semibold text-white mb-3">How to Prepare for UPTET</h3>
              <ol className="list-decimal pl-5 space-y-2">
                <li><strong className="text-white">Master Child Development &amp; Pedagogy (CDP).</strong> It carries 30 marks and is the most scoring section once you understand the theories of Piaget, Vygotsky and Kohlberg. Focus on application, not rote learning.</li>
                <li><strong className="text-white">Solve previous year papers.</strong> UPTET repeats patterns and even questions. Practising <a href="/uptet/previous-year-papers" className="text-blue-400 underline">UPTET previous year papers</a> is the single highest-return activity.</li>
                <li><strong className="text-white">Practise in a timed, exam-like environment.</strong> Reading notes is not the same as performing under a clock. Take full mock tests on Prepify to build speed and accuracy together.</li>
                <li><strong className="text-white">Revise language pedagogy.</strong> Both language sections reward comprehension and teaching-method questions — these are easy marks with consistent practice.</li>
                <li><strong className="text-white">Track your weak subjects</strong> and give them extra subject-wise practice until your accuracy crosses 80%.</li>
              </ol>
            </section>

            <section>
              <h3 className="text-xl font-semibold text-white mb-3">Why practise UPTET on Prepify</h3>
              <p>
                Prepify recreates the real test experience: a clean exam interface, a question palette, a timer, and
                instant solutions after you submit. You can practise a single subject, take a full Paper I or Paper II
                mock, or attempt year-wise previous papers — all completely free, with a bilingual Hindi/English toggle.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-white font-medium">Is UPTET mock test on Prepify free?</p>
                  <p>Yes. All UPTET practice — subject-wise tests, full mocks and previous year papers — is completely free.</p>
                </div>
                <div>
                  <p className="text-white font-medium">What are the qualifying marks for UPTET?</p>
                  <p>General category candidates need 90 out of 150 (60%). Reserved categories typically need 82.5 (55%). Always verify with the official notification.</p>
                </div>
                <div>
                  <p className="text-white font-medium">How long is the UPTET certificate valid?</p>
                  <p>The UPTET certificate is currently valid for 5 years from the date of result, though candidates should check the latest UPBEB rules.</p>
                </div>
                <div>
                  <p className="text-white font-medium">Is there negative marking in UPTET?</p>
                  <p>No. There is no negative marking, so you should attempt all 150 questions.</p>
                </div>
              </div>
            </section>
          </article>
